...
<tileset version="1.8" tiledversion="1.8.4" name="DayTileset" tilewidth="16" tileheight="16" tilecount="400" columns="20">
 <editorsettings>
  <export target="DayTileset.tsj" format="json"/>
 </editorsettings>
 <image source="DayTileset.png" width="320" height="320"/>
 <tile id="0" type="Wall"/>
 <tile id="1" type="Wall"/>
 <tile id="2" type="Wall"/>
 <tile id="3" type="Wall"/>
